...
```
## Abstract
The main aim of this project is to predict the a behavior pattern labelled as "classe" variable from exercise activities. Then apply the best machine learning algorithm to the 20 test cases available in the test data provided.
